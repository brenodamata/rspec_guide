describe 'Expectation Matchers' do
  ...
  describe 'collection matchers' do
    ...
    it 'will match arrays' do
      ...
      expect(array).to match_array([3,2,1])  # Like array, contais the same objects regardless of order
  ...
  describe 'predicate matchers' do
    ...
    it 'will match have_* to custom methods like has_*?' do
      ...
      expect(customer).not_to have_new_order  # test
    end
  ...
  describe 'observation matchers' do
    ...
    it 'will match when errors are raised' do
      ...
      # Actual error raised was #<StandardError: StandardError>. Instead consider providing a specific error class or
      # message. This message can be suppressed by setting: `RSpec::Expectations.configuration.on_potential_false_positives = :nothing`.
      # Called from expectation_matchers_spec.rb:278:in `block (3 levels) in <top (required)>'.
